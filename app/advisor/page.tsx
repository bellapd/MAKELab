  ...
  return (
    <div className="min-h-screen max-w-5xl mx-auto px-6 py-26 pt-52 bg-white">
            ...
            <div className="md:col-span-3 space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 pl-4">Professor of Department of Computer Science by Joint Appointment <b>National Tsing Hua University</b></p> <br/>
                  <p className="text-gray-600 pl-4">Chair Professor of Department of Computer Science and Information Engineering <br/> Dean of College of Information and Electrical Engineering <br/><b>Asia University</b></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-green-500 pl-6 py-2">
                ...
                <p className="text-gray-600">Chair Professor of Department of Computer Science and Information Engineering 
                <br/> 
                Vice President of Department of Computer Science and Information Engineering
                <br/> 
                Dean of College of Information and Electrical Engineering</p>
              </div>
      ...
      {/* PhD Thesis Supervision */}
        <div className="mt-20 pt-16 border-t border-gray-200">
          <h3 className="text-3xl font-bold text-gray-900 mb-12 text-center">PhD Thesis Supervision </h3>
      ...
      {/* Program Comitee*/}
        <div className="mt-20 pt-16 pb-32 border-t border-gray-200">
          <h3 className="text-3xl font-bold text-gray-900 mb-12 text-center">Program Comitee</h3>
          <div className="w-full max-w-6xl mx-auto">
