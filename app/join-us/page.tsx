...
export default function JoinUsPage() {
  return (
    <div className="max-w-7xl mx-auto px-6 pt-52 pb-32 bg-white">
      {/* Header */}
      <div className="text-center mb-16">
        <h1 className="text-5xl font-bold mb-6 text-black">Lab Location</h1>
      </div>

      {/* Layout */}
      <div className="flex flex-col md:flex-row items-stretch justify-center gap-6">
        {/* Map Card */}
        <Card className="flex-1 w-full shadow-xl border-0 bg-white/80 backdrop-blur-sm">
        ...
        <Card className="flex-1 w-full shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="p-6 text-center">
            <h3 className="text-gray-600 mb-6 text-xl">
              For more questions, please reach us at the following contact
              information:
            </h3>
